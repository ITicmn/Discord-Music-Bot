...
NICONICO = 'C:/Users/USER/Desktop/code/Game Development/little projects/music bot/Audio/NicoNico/'

#ydl_opts = {'format': 'bestaudio', 'noplaylist':'True','outtmpl': 'C:/Users/USER/Desktop/code/Game Development/little projects/music bot/Audio/%(title)s.%(ext)s',"windowsfilenames":'True'}
...
def apple_music_download(url):
    subprocess.run(["py","-m","gamdl","-c","C:/Users/USER/Desktop/code/Game Development/little projects/music bot/apple_music_cookie/cookies.txt","-o",f"{APPLE_MUSIC}temporary","--template-folder-album","","--no-synced-lyrics",url])
    info = []
